...
4. **Subnets**: Contiguous range of IP addresses in a VPC - AZ Scope
5. **AWS Fargate**: Serverless Compute Engine provided by AWS - Used to run containers without managing underlying infrastructure
